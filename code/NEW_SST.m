...
% 未滤波 SST 分析 
S_matrix_unfilt = cell(1, num_channels);    % 存储未滤波各通道 SST 谱
...
% 滤波后 SST 分析 
S_matrix = cell(1, num_channels);    % 存储滤波后各通道 SST 谱
...
figure;
title('NEW-SST MUSIC Spectrum Estimation', 'FontSize', 16, 'FontWeight', 'bold');
...
legend('NEW-SST MUSIC Spectrum', 'Location', 'Best', 'FontSize', 12);
